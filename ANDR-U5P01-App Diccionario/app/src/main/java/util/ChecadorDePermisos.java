...
:*
:*                  Activity que nos permite checar los permisos.
:*
:*  Archivo     : ChecadorDePermiso.java
:*  Autores     : Eduardo Ivan Guerrero Hernández   19130918
:*              : Janeth Díaz Cruz                  19131498
:*  Fecha       : 20/May/2023
:*  Compilador  : Android Studio Electric Eel 2022.1
:*  Descripción : Este Activity un conjunto de métodos para el chequeo de permisos y
                  validar los permisos.
:*  Ultima modif:
:*  Fecha       Modificó                            Motivo
:*==========================================================================================
:*  20/May/2023  Eduardo Ivan Guerrero Hernández     Se implementaron los métodos para checar los
                 Janeth Diaz Cruz                    permisos, donde preguntan y pueden activarlos.
:*------------------------------------------------------------------------------------------*/
...
// Creación de la clase 'ChecadorDePermisos':-------------------------------------------------------
public class ChecadorDePermisos {
    ...
    // Método que verifica los permisos solicitados.
    ...
    {
        // Crea un arreglo del tamaño de los permisos requeridos.
        ArrayList<String> arrTmp = new ArrayList<> ();
        for ( int i = 0; i < permisosReq.length; i++ )
            arrTmp.add ( permisosReq [ i ].getPermiso () );
    ...
    // Método donde si no se cumplen con los requerimientos, notifica y cierra el programa.
